...
int main()
{
	std::wstring outputFile = OutputPath"SetTextMargins.pptx";
	...
	//Append a new shape
	IAutoShape* shape = ppt->GetSlides()->GetItem(0)->GetShapes()->AppendShape(ShapeType::Rectangle, new RectangleF(50, 100, 450, 150));
