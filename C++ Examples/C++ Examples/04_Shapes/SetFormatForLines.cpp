...
int main()
{
	std::wstring outputFile = OutputPath"SetFormatForLines.pptx";
	...
	IAutoShape* shape = ppt->GetSlides()->GetItem(0)->GetShapes()->AppendShape(ShapeType::Rectangle, new RectangleF(100, 150, 200, 100));
