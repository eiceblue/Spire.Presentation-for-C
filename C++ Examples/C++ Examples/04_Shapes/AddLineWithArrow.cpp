...
int main()
{
	std::wstring outputFile = OutputPath"AddLineWithArrow.pptx";
	...
	IAutoShape* shape = ppt->GetSlides()->GetItem(0)->GetShapes()->AppendShape(ShapeType::Line, new RectangleF(150, 100, 100, 100));
