...
int main()
{
	std::wstring outputFile = OutputPath"Set3DEffectForShape.pptx";

	//Create an instance of presentation document
	Presentation* ppt = new Presentation();

	//Set background image
	std::wstring ImageFile = DataPath"Demo/bg.png";
	...
	IAutoShape* shape1 = ppt->GetSlides()->GetItem(0)->GetShapes()->AppendShape(ShapeType::RoundCornerRectangle, new RectangleF(150, 150, 150, 150));
	...
	IAutoShape* shape2 = ppt->GetSlides()->GetItem(0)->GetShapes()->AppendShape(ShapeType::Pentagon, new RectangleF(400, 150, 150, 150));
