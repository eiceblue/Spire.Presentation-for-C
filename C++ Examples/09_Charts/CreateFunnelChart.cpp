...
int main()
{
	std::wstring outputFile = OutputPath"CreateFunnelChart.pptx";

	//Create a PPT document
	Presentation* ppt = new Presentation();

	//Create a Funnel chart to the first slide
	IChart* chart = ppt->GetSlides()->GetItem(0)->GetShapes()->AppendChart(ChartType::Funnel, new RectangleF(50, 50, 550, 400), false);
