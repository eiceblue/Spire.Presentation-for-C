...
int main()
{
	std::wstring outputFile = OutputPath"CreateLineMarkersChart.pptx";
	...
	IChart* chart = ppt->GetSlides()->GetItem(0)->GetShapes()->AppendChart(ChartType::LineMarkers, rect1, false);
