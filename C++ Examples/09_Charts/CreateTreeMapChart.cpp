...
int main()
{
	std::wstring outputFile = OutputPath"CreateTreeMapChart.pptx";

	//Create a PPT document
	Presentation* ppt = new Presentation();

	//Create a TreeMap chart to the first slide
	IChart* chart = ppt->GetSlides()->GetItem(0)->GetShapes()->AppendChart(ChartType::TreeMap, new RectangleF(50, 50, 500, 400), false);
